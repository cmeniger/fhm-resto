    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add(
                'title',
                TextType::class,
                array('label' => $this->instance->translation.'.admin.update.form.title', 'required' => false)
            )
            ->add(
                'subtitle',
                TextType::class,
            ...
            ->add(
                ...
                TextType::class,
                array(
                    'label' => $this->instance->translation.'.admin.update.form.legalnotice',
                    'required' => false,
            ...
            ->add(
                'social_facebook',
                TextType::class,
                array('label' => $this->instance->translation.'.admin.update.form.social.facebook', 'required' => false)
            )
            ->add(
                'social_facebook_id',
                TextType::class,
                array(
                    'label' => $this->instance->translation.'.admin.update.form.social.facebookId',
                    'required' => false,
                )
            )
            ->add(
                'social_twitter',
                TextType::class,
                array('label' => $this->instance->translation.'.admin.update.form.social.twitter', 'required' => false)
            )
            ->add(
                'social_twitter_id',
                TextType::class,
                array(
                    'label' => $this->instance->translation.'.admin.update.form.social.twitterId',
                    'required' => false,
                )
            )
            ->add(
                'social_google',
                TextType::class,
                array('label' => $this->instance->translation.'.admin.update.form.social.google', 'required' => false)
            )
            ->add(
                'social_google_id',
                TextType::class,
                array('label' => $this->instance->translation.'.admin.update.form.social.googleId', 'required' => false)
            )
            ->add(
                'social_instagram',
                TextType::class,
                array(
                    'label' => $this->instance->translation.'.admin.update.form.social.instagram',
                    'required' => false,
                )
            )
            ->add(
                'social_youtube',
                TextType::class,
                array('label' => $this->instance->translation.'.admin.update.form.social.youtube', 'required' => false)
            )
            ->add(
                'social_flux',
                TextType::class,
                array('label' => $this->instance->translation.'.admin.update.form.social.flux', 'required' => false)
            )
            ->remove('global')
            ->remove('share');
    }
