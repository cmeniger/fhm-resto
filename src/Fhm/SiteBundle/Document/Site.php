<?php
namespace Fhm\SiteBundle\Document;
...
/**
 * Site
 * @MongoDB\Document(repositoryClass="Fhm\SiteBundle\Repository\SiteRepository")
...
class Site extends FhmFhm
{
    ...
    /**
     * @MongoDB\ReferenceOne(targetDocument="Fhm\MenuBundle\Document\Menu", nullable=true)
     */
    protected $menu;
     ...
     * Set menu
     *
     * @param \Fhm\MenuBundle\Document\Menu $menu
     *
     * @return $this
     */
    public function setMenu($menu)
    {
        $this->menu = ($menu instanceof \Fhm\MenuBundle\Document\Menu) ? $menu : null;
     ...
     * Get menu
     *
     * @return \Fhm\MenuBundle\Document\Menu $menu
     */
