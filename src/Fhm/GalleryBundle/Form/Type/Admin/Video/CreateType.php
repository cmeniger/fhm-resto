    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('order', IntegerType::class, array(
                'label' => $options['translation_route'] . '.admin.create.form.order', 'required' => false))
            ->add('video', UrlType::class, array('label' => $options['translation_route'] . '.admin.create.form.video'))
