...
class CreateType extends GeolocationType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('phone', TextType::class, array('label' => $this->instance->translation . '.admin.create.form.phone', 'required' => false))
            ->add('fax', TextType::class, array('label' => $this->instance->translation . '.admin.create.form.fax', 'required' => false))
            ->add('email', EmailType::class, array('label' => $this->instance->translation . '.admin.create.form.email', 'required' => false))
            ->add('form', CheckboxType::class, array('label' => $this->instance->translation . '.admin.create.form.form.check', 'required' => false))
            ->add('form_template', TextType::class, array('label' => $this->instance->translation . '.admin.create.form.form.template', 'required' => false))
            ->add('profile', CheckboxType::class, array('label' => $this->instance->translation . '.admin.create.form.profile.check', 'required' => false))
            ->add('profile_template', TextType::class, array('label' => $this->instance->translation . '.admin.create.form.profile.template', 'required' => false))
