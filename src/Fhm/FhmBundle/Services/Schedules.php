    ...
    private function _formatState($day)
    {
        ...
        if (isset($this->data['days'][$day - 1])) {
            ...
            $formattedValue = array(
                ...
                isset($formattedDay[1]) && $formattedDay[1] != '' && $formattedDay[1] != 'close' ? str_replace(
                    ':',
                    '',
                    $formattedDay[1]
                ) : '',
                isset($formattedDay[2]) && $formattedDay[2] != '' && $formattedDay[2] != 'close' ? str_replace(
                    ':',
                    '',
                    $formattedDay[2]
                ) : '',
                isset($formattedDay[3]) && $formattedDay[3] != '' && $formattedDay[3] != 'close' ? str_replace(
                    ':',
                    '',
                    $formattedDay[3]
                ) : '',
