...
class CreateType extends AbstractType
{
    ...
    {
        $builder
            ->add('name', 'text', array('label' => $this->instance->translation . '.admin.create.form.name'))
            ->add('description', 'textarea', array('label' => $this->instance->translation . '.admin.create.form.description', 'required' => false))
            ...
            ->add('active', 'checkbox', array('label' => $this->instance->translation . '.admin.create.form.active', 'required' => false))
            ->add('submitSave', 'submit', array('label' => $this->instance->translation . '.admin.create.form.submit.save'))
            ->add('submitNew', 'submit', array('label' => $this->instance->translation . '.admin.create.form.submit.new'))
