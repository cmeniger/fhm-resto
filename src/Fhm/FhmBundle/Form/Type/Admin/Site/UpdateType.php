    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add(
                'show_slider',
                CheckboxType::class,
                array('label' => $options['translation_route'].'.admin.update.form.show', 'required' => false)
            )
            ->add(
                'show_gallery_top',
                CheckboxType::class,
            ...
            ->add(
                ...
                array(
                    ...
                    'attr'     => ['placeholder' => $options['translation_route'] . '.admin.update.form.social.placeholder.link'],
                    'required' => false,
                )
            )
            ->add(
                ...
                array(
                    ...
                    'attr'     => ['placeholder' => $options['translation_route'] . '.admin.update.form.social.placeholder.id'],
                    'required' => false,
                )
            )
            ->add(
