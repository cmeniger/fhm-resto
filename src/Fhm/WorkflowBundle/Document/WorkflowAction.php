...
/**
 * WorkflowAction
 * @MongoDB\Document(repositoryClass="Fhm\WorkflowBundle\Document\Repository\WorkflowActionRepository")
 */
class WorkflowAction extends FhmFhm
{
    /**
    ...
    /**
     * @MongoDB\ReferenceMany(targetDocument="Fhm\UserBundle\Document\User", nullable=true, cascade={"persist"})
     */
     ...
     * @return $this
     */
    public function addValidateUsers(\Fhm\UserBundle\Document\User $user)
    {
     ...
     * @return $this
     */
    public function removeValidateUsers(\Fhm\UserBundle\Document\User $user)
    {
        if($this->validate_users->contains($user))
        {
     ...
     * @return $this
     */
    public function addDismissUsers(\Fhm\UserBundle\Document\User $user)
    {
     ...
     * @return $this
     */
    public function removeDismissUsers(\Fhm\UserBundle\Document\User $user)
    {
        if($this->dismiss_users->contains($user))
        {
     ...
     * @return $this
     */
    public function addCancelUsers(\Fhm\UserBundle\Document\User $user)
    {
     ...
     * @return $this
     */
    public function removeCancelUsers(\Fhm\UserBundle\Document\User $user)
    {
        if($this->cancel_users->contains($user))
        {
     ...
     * @return $this
     */
    public function addUploadUsers(\Fhm\UserBundle\Document\User $user)
    {
     ...
     * @return $this
     */
    public function removeUploadUsers(\Fhm\UserBundle\Document\User $user)
    {
        if($this->upload_users->contains($user))
        {
     ...
     * @return $this
     */
    public function addDownloadUsers(\Fhm\UserBundle\Document\User $user)
    {
     ...
     * @return $this
     */
    public function removeDownloadUsers(\Fhm\UserBundle\Document\User $user)
    {
        if($this->download_users->contains($user))
        {
     ...
     * @return $this
     */
    public function addCommentUsers(\Fhm\UserBundle\Document\User $user)
    {
     ...
     * @return $this
     */
    public function removeCommentUsers(\Fhm\UserBundle\Document\User $user)
    {
        if($this->comment_users->contains($user))
        {
