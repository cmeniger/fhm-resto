    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add(
                'first_name',
                TextType::class,
                array('label' => $this->translation.'.admin.create.form.first_name', 'required' => false)
            )
            ->add(
                'last_name',
                TextType::class,
                array('label' => $this->translation.'.admin.create.form.last_name', 'required' => false)
            )
            ->add(
                'birth_date',
                BirthdayType::class,
                array('label' => $this->translation.'.admin.create.form.birth_date', 'required' => false)
            )
            ->add(
                'tel1',
                TextType::class,
                array('label' => $this->translation.'.admin.create.form.tel1', 'required' => false)
            )
            ->add(
                'tel2',
                TextType::class,
                array('label' => $this->translation.'.admin.create.form.tel2', 'required' => false)
            )
            ->add(
                'enabled',
                CheckboxType::class,
                array('label' => $this->translation.'.admin.create.form.enabled', 'required' => false)
            )
            ->add(
                'locked',
                CheckboxType::class,
                array('label' => $this->translation.'.admin.create.form.locked', 'required' => false)
            )
            ->add(
                'sign',
                TextareaType::class,
                array(
                    'label' => $this->translation.'.admin.create.form.sign',
            ...
            ->add(
                'social_facebook_id',
                TextType::class,
                array('label' => $this->translation.'.admin.create.form.social.facebookId', 'required' => false)
            )
            ->add(
                'social_twitter',
                TextType::class,
            ...
            ->add(
                'social_twitter_id',
                TextType::class,
                array('label' => $this->translation.'.admin.create.form.social.twitterId', 'required' => false)
            )
            ->add(
                'social_google',
                TextType::class,
            ...
            ->add(
                'social_instagram',
                TextType::class,
                array('label' => $this->translation.'.admin.create.form.social.instagram', 'required' => false)
            )
            ->add(
                'social_youtube',
                TextType::class,
