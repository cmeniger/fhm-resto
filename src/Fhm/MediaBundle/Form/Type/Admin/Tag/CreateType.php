...
class CreateType extends FhmType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('color', 'text', array('label' => $this->translation . '.admin.create.form.color', 'attr' => array('class' => 'colorpicker'), 'required' => false))
            ->add('private', 'checkbox', array('label' => $this->translation . '.admin.create.form.private', 'required' => false))
